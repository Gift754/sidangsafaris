  ...
  return (
    <div className="HomePage">
      ...
      <div className="hero">
        ...
        Sidan Adventures is a premier tour company based in Kenya, dedicated to
        providing exceptional travel experiences that showcase the rich cultural
        heritage, diverse landscapes, and unique wildlife of this East African
        gem. Established with a passion for exploration and a commitment to
        excellence, Sidang Safaris has become a trusted name in the travel
        industry, offering personalized and unforgettable adventures.
      </div>
          ...
          <div className="search-item">
            ...
            <div className="input-group">
              ...
              <select id="destination" name="destination">
                <option value="" disabled selected hidden className="rare">
