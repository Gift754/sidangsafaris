...
export default function Home() {
  ...
  const destinations = [
    {
      title: "Tented Camps",
      description:
        "Experience the wilderness in comfort with our luxury tented camps situated in the heart of nature.",
      image: tentedCampsImage,
    },
    {
      title: "Balloon Safaris",
      description:
        "Soar above stunning landscapes and witness wildlife from a unique perspective with our balloon safaris.",
      image: balloonSafariImage,
    },
    {
      title: "Maasai Mara",
      description:
        "Visit one of Africa's most magnificent game reserves, famous for the Great Migration and abundant wildlife.",
      image: maasaiMaraImage,
    },
    {
      title: "Nakuru National Park",
      description:
        "Famous for its flamingos and diverse birdlife, Lake Nakuru is a birdwatcher's paradise.",
      image: nakuruParkImage,
    },
    {
      title: "Samburu National Park",
      description:
        "Discover unique wildlife species and experience the rich culture of the Samburu people.",
  ...
  const offers = [
    ...
    },
    {
      ...
      features: ["Big Five Safari", "Luxury Lodge Stay", "Scenic Drives"],
      price: "KES 1500",
    },
    {
      ...
      features: ["Museum Visits", "Giraffe Centre", "Karen Blixen House"],
      price: "KES 600",
    },
                  ...
                  onClick={() => {
                    if (destTrackRef.current) {
                      ...
                      destTrackRef.current.scrollTo({
                        left: idx * cardWidth * CARDS_PER_VIEW,
                        behavior: "smooth",
                      });
                    }
                  }}
      ...
      <section>
        <section className="offers-section">
          ...
          <div className="offers-carousel-row">
            ...
            >
              <div
                className="offers-carousel-cards"
                style={{ display: "flex", gap: "30px" }}
              >
                  ...
                  onClick={() => {
                    if (offersTrackRef.current) {
                      ...
                      offersTrackRef.current.scrollTo({
                        left: idx * cardWidth * OFFERS_PER_VIEW,
                        behavior: "smooth",
                      });
                    }
                  }}
            ...
            <div className="testimonials-grid">
              ...
              <div className="testimonial-card">
                <div className="testimonial-content">
                  <p>
                    We had an amazing time on our trip to Kenya with Sidan
                    Adventures. The tour was well-organised and the guides were
                    very knowledgeable.
                  </p>
                </div>
